 ...
 * @author omie
 */
class ParcelasJsonClient {
	/**
	 * The WSDL URI
	 *
	 * @var string
	 */
	public static $_WsdlUri='http://app.omie.com.br/api/v1/geral/parcelas/?WSDL';
	/**
	 ...
	 * @var string
	 */
	public static $_EndPoint='http://app.omie.com.br/api/v1/geral/parcelas/';
	 ...
	 */
	public function ListarParcelas($parcelaListarRequest){
		return self::_Call('ListarParcelas',Array(
...
/**
 * Solicitação da listagem de parcelas disponíveis.
 *
 ...
 * @pw_complex parcelaListarRequest
 */
class parcelaListarRequest{
	/**
