    ...
    var Wa = {},
        ...
        Ba = function() {
            var m = /D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g,
                q = "Domingo Segunda Terça Quarta Quinta Sexta Sábado".split(" "),
                s = "Dom Seg Ter Qua Qui Sex Sab".split(" "),
                v = "Janeiro Fevereiro Março Abril Maio Junho Julho Agosto Setembro Outubro Novembro Dezembro".split(" "),
                y = "Jan Fev Mar Abr Mai Jun Jul Ago Set Out Nov Dez".split(" "),
