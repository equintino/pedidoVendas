...
<div id="sidebar" class="sidebar-toggle">
    <ul class="nav nav-sidebar">
        ...
        <li data-toggle="collapse" href="#chart-types" aria-expanded="true" aria-controls="chart-types">
            <a href="#"><i class="fa fa-area-chart" aria-hidden="true"></i><span>CHART TYPES</span>
            </a>
        </li>
        <li>
		...
		<li><a href="/chart-types/range-spline.php">Range Spline Area Chart</a></li>                <li><a href="/chart-types/ohlc.php">OHLC Chart</a></li>
