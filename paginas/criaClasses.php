<?php
    class criaClsses {
        ...
        public function novoArquivo($campos){
            $variaveis=array('modificado','inscricao_suframa','produtor_rural','recomendacao_atraso','logradouro','importado_api','bloqueado','codInt','comissao','fatura_pedido','visualiza_pedido','nome','inativo','codigo');//email
            $mode='w+';
