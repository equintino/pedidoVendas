<?php 
 class CRUDConta extends Dao{
   public function insert5(conta $conta){
                ...
                $sql = 'INSERT INTO tb_conta (`bol_instr1`,`bol_sn`,`cobr_sn`,`codigo_agencia`,`codigo_banco`,`data_alt`,`data_inc`,`descricao`,`dias_rcomp`,`hora_alt`,`hora_inc`,`nCodCC`,`nao_fluxo`,`nao_resumo`,`numero_conta_corrente`,`pdv_cod_adm`,`pdv_dias_venc`,`pdv_enviar`,`pdv_limite_pacelas`,`pdv_num_parcelas`,`pdv_sincr_analitica`,`pdv_taxa_adm`,`pdv_taxa_loja`,`pdv_tipo_tef`,`per_juros`,`per_multa`,`saldo_inicial`,`tipo`,`tipo_conta_corrente`,`user_alt`,`user_inc`,`valor_limite`,`OMIE_APP_KEY`,`id`,`excluido`,`criado`) VALUES (:bol_instr1,:bol_sn,:cobr_sn,:codigo_agencia,:codigo_banco,:data_alt,:data_inc,:descricao,:dias_rcomp,:hora_alt,:hora_inc,:nCodCC,:nao_fluxo,:nao_resumo,:numero_conta_corrente,:pdv_cod_adm,:pdv_dias_venc,:pdv_enviar,:pdv_limite_pacelas,:pdv_num_parcelas,:pdv_sincr_analitica,:pdv_taxa_adm,:pdv_taxa_loja,:pdv_tipo_tef,:per_juros,:per_multa,:saldo_inicial,:tipo,:tipo_conta_corrente,:user_alt,:user_inc,:valor_limite,:OMIE_APP_KEY,:id,:excluido,:criado)';
